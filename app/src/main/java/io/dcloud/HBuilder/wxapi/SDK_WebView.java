...
class WebviewModeListener implements ICoreStatusListener {
	...
	public void onCoreInitEnd(ICore coreHandler) {
		// 设置单页面集成的appid
//		String appid = "__UNI__1E9B0DD";
		String appid = "cn.shtoone.HncqProcess.xianchang";
		// 单页面集成时要加载页面的路径，可以是本地文件路径也可以是网络路径
		String url = "file:///android_asset/apps/cn.shtoone.HncqProcess.xianchang/www/index.html";
//		String url = "file:///android_asset/apps/__UNI__1E9B0DD/www/index.html";
